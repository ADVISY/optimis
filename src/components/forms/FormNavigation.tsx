  ...
  return (
    <div className="flex flex-col-reverse sm:flex-row justify-between gap-2 sm:gap-4 pt-4 md:pt-8">
      <Button
        ...
        className="gap-1.5 sm:gap-2.5 w-full sm:w-auto sm:min-w-[120px] md:min-w-[140px] h-10 md:h-14 text-xs md:text-base font-semibold border-2 border-white/40 bg-white/10 text-white hover:bg-white/20 hover:border-white/60 transition-all duration-200 backdrop-blur-sm"
      >
        <ArrowLeft className="h-3.5 w-3.5 md:h-5 md:w-5" />
        {t("forms.previous")}
      </Button>
      ...
      <Button
        ...
        className={`
          gap-1.5 sm:gap-2.5 w-full sm:w-auto sm:min-w-[160px] md:min-w-[200px] h-10 md:h-14 text-xs md:text-base font-bold
      ...
      >
        {isSubmitting ? (
          <>
            <Loader2 className="h-3.5 w-3.5 md:h-5 md:w-5 animate-spin" />
