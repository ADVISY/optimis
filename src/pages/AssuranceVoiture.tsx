...
const features = [
  { icon: Shield, title: "Protection complète", description: "RC, casco partielle ou complète" },
        ...
        <div className="container">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mb-8 text-muted-foreground">
              Remplissez le formulaire et recevez les meilleures offres en quelques minutes.
            </p>
            <Card>
