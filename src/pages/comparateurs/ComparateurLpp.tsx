...
import { Shield, CheckCircle, Clock, Banknote, Search } from "lucide-react";
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-3xl mx-auto text-center mb-5 md:mb-8">
              ...
              <h1 className="font-heading text-xl sm:text-2xl md:text-3xl lg:text-4xl font-black leading-tight text-foreground tracking-tight uppercase mb-2">
                {t("lpp.heroTitle", "AVOIRS LPP : RÉCUPÉREZ VOTRE 2E PILIER OUBLIÉ")}
              </h1>
              <p className="text-sm md:text-base text-muted-foreground mb-3 max-w-xl mx-auto">
                {t("lpp.heroSubtitle", "Vous avez travaillé en Suisse ? Votre argent LPP peut être en attente sans que vous le sachiez.")}
              </p>
              <div className="flex flex-col items-start gap-1.5 max-w-md mx-auto text-left">
                <div className="flex items-center gap-2 text-primary font-semibold text-xs md:text-sm">
                  ...
                  {t("lpp.heroBullet1", "Vérification en 1 minute")}
                </div>
                <div className="flex items-center gap-2 text-primary font-semibold text-xs md:text-sm">
                  <Banknote className="h-4 w-4 shrink-0" />
                  {t("lpp.heroBullet2", "En moyenne CHF 12'838 par personne")}
                </div>
                <div className="flex items-center gap-2 text-primary font-semibold text-xs md:text-sm">
                  <Search className="h-4 w-4 shrink-0" />
                  {t("lpp.heroBullet3", "Retrouvez et réunissez vos fonds LPP")}
                </div>
              </div>
            </div>
            ...
            <div className="max-w-3xl mx-auto text-center mt-12 pt-8 border-t border-border/50">
              <div className="inline-flex items-center gap-2 bg-primary/10 text-primary px-4 py-2 rounded-full text-sm font-medium mb-4">
                ...
                {t("lpp.badge", "Libre passage LPP")}
              </div>
              <h2 className="text-2xl md:text-3xl font-bold mb-4">
                {t("lpp.seoTitle", "Le libre passage LPP, simplement")}
              </h2>
              <p className="text-lg text-muted-foreground mb-6">
                {t("lpp.seoDescription", "Quand vous quittez un emploi en Suisse, votre 2e pilier ne disparaît pas. Il est transféré sur un compte en attente appelé libre passage.")}
              </p>
