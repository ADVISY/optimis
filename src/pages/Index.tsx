          ...
          <div className="grid items-center gap-8 md:grid-cols-2">
            <div className="space-y-6 animate-fade-in">
              <h1 className="font-heading text-4xl font-black leading-tight text-foreground uppercase md:text-5xl lg:text-6xl">
                {t('home.heroTitle')} <span className="text-gradient-optimis">{t('home.heroHighlight')}</span>
              </h1>
              <p className="font-heading text-lg font-black uppercase text-muted-foreground md:text-xl">{t('home.heroSubtitle')}</p>
