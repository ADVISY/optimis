...
import HealthInsuranceFormLegacy from "@/components/forms/legacy/HealthInsuranceFormLegacy";
import { Shield, CheckCircle, Clock, BadgePercent, HeartPulse } from "lucide-react";

// ============================================================================
// LP Google — /lp-google
// ----------------------------------------------------------------------------
// Reprend l'ANCIENNE expérience assurance maladie (formulaire + design d'avant la
// refonte « tunnel 1-question/étape »), servie spécifiquement pour Google Ads.
//   • Formulaire legacy isolé (HealthInsuranceFormLegacy + FormContainerLegacy…)
//     → n'impacte pas le tunnel actuel /assurance-maladie-landing.
//   • Même envoi de lead : formType "health-insurance" (Zapier + BD identiques).
//   • noindex : c'est une LP publicitaire, on évite le doublon SEO avec le tunnel.
// ============================================================================
const LpGoogleSante = () => {
  ...
  return (
    <>
      <Seo
        title="Comparateur assurance maladie 2026 – devis gratuit"
        description="Comparez gratuitement les primes d'assurance maladie en Suisse et économisez. Devis rapide, sans engagement."
        canonicalPath="lp-google"
        noindex
      />
      <Layout>
