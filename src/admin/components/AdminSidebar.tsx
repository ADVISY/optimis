...
import { LayoutDashboard, Users, ShoppingBag, FileText, LogOut, User, Settings, Package, Inbox, Send, History, Star, TrendingUp } from "lucide-react";
...
const navItems = [
  ...
  { to: "/admin/acquisition", label: "Acquisition", icon: TrendingUp, end: false },
